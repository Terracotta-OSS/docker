...
You can re use the same docker-compose.yml file :
    ...
    hrzyj5z2uwkh  terracotta_terracotta_2.1  terracotta/terracotta-server-oss:4.3.2  moby  Running        Running 24 seconds ago         
    944cftq26cis  terracotta_terracotta_1.1  terracotta/terracotta-server-oss:4.3.2  moby  Running        Running 25 seconds ago      
